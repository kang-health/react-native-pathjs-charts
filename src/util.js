...
export class Options {
    ...
    get axisX() {
        return (
            this.props.axisX ||
            (this.props.options && this.props.options.axisX) ||
            {}
        )
    }
    get axisY() {
        return (
            this.props.axisY ||
            (this.props.options && this.props.options.axisY) ||
            {}
        )
    }
    get margin() {
    ...
    get stroke() {
        return (
            this.props.stroke ||
            (this.props.options && this.props.options.stroke)
        )
    }
    get fill() {
        return (
            this.props.fill || (this.props.options && this.props.options.fill)
        )
    }
    get r() {
